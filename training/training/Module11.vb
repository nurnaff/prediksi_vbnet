...
Module Module11
    ...
    Sub main()
        koneksi()
        For i = 0 To 10
            cm = New OdbcCommand("select titik_x from kanan_bawah where no=" & i, kon)
            x1(i) = cm.ExecuteScalar
        Next
        For i = 0 To 10
            cm = New OdbcCommand("select titik_y from kanan_bawah where no=" & i, kon)
            x2(i) = cm.ExecuteScalar
        Next
        For i = 0 To 10
            cm = New OdbcCommand("select y from kanan_bawah where no=" & i, kon)
