...
Module Module10
    ...
    Sub main()
        koneksi()
        For i = 0 To 10
            cm = New OdbcCommand("select titik_x from kiri_bawah where no=" & i, kon)
            x1(i) = cm.ExecuteScalar
        Next
        For i = 0 To 10
            cm = New OdbcCommand("select titik_y from kiri_bawah where no=" & i, kon)
            x2(i) = cm.ExecuteScalar
        Next
        For i = 0 To 10
            cm = New OdbcCommand("select y from kiri_bawah where no=" & i, kon)
